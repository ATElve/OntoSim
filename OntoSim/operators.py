...
from OntoSim.objects import *   # Import variable, tempvariable and collections
from OntoSim.operatorImplementation import *   # Self made additional operators
import OntoSim.myerrors                                  # My error definitions
